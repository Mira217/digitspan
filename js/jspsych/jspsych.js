  ...
  function startExperiment() {
    ...
    if (fullscreen) {
      ...
      if (keyboardNotAllowed) {
        ...
        DOM_target.append('<div class = jspsych-instructions-nav><br><br><br><br><br><p>This experiment will take <strong>about 10 minutes.</p><button id="jspsych-fullscreen-btn" class="jspsych-btn">Next</button></div>');
